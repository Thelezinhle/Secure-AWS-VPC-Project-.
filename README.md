...
![Secure AWS VPC Architecture Diagram][https://github.com/Thelezinhle/Secure-AWS-VPC-Project-./blob/main/architecture-diagram.drawio.png](https://github.com/Thelezinhle/Secure-AWS-VPC-Project-/raw/main/architecture-diagram.drawio.png)
